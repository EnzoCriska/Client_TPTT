...
import { RenderPlayTrain } from './render';
...
export default class PlayTrain extends Component {
  ...
  render() {
    const {sourceA, sourceB, sourceC, GameOverModalVisible, question, answerA, answerB, fill} = this.state
    return (
